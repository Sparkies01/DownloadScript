# Paquito Visual Skins

Validated visual-skin packages. All downloads are published in the
[`visual-paquito`](https://github.com/Sparkies01/DownloadScript/releases/tag/visual-paquito) release.

| Package | Download |
| --- | --- |
| Backup | [Paquito-Backup.zip](https://github.com/Sparkies01/DownloadScript/releases/download/visual-paquito/Paquito-Backup.zip) |
...
| Ryu 2 | [Paquito-Ryu-2.zip](https://github.com/Sparkies01/DownloadScript/releases/download/visual-paquito/Paquito-Ryu-2.zip) |
