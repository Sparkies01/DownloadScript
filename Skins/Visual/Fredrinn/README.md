# Fredrinn Visual Skins

Validated visual-skin packages. All downloads are published in the
[`visual-fredrinn`](https://github.com/Sparkies01/DownloadScript/releases/tag/visual-fredrinn) release.

| Package | Download |
| --- | --- |
| Backup | [Fredrinn-Backup.zip](https://github.com/Sparkies01/DownloadScript/releases/download/visual-fredrinn/Fredrinn-Backup.zip) |
